...
export function Header({ userRole, onRoleSwitch, onMenuToggle }) {
  ...
  return (
    <header className="border-b glass sticky top-0 z-50 backdrop-blur-lg">
      <div className="container flex items-center justify-between h-16 px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="ghost" size="icon" className="relative hover:bg-primary/10 group">
            ...
            <Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 text-xs gradient-primary animate-pulse">
              3
            </Badge>
          </Button>
